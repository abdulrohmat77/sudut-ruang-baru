    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="profiles">
        <TabsList className="flex-wrap h-auto">
          <TabsTrigger value="profiles">Profil ({profiles.data.length ?? 0})</TabsTrigger>
          <TabsTrigger value="projects">Proyek ({d.length ?? 0})</TabsTrigger>
          <TabsTrigger value="deliverables">Deliverable ({d.length ?? 0})</TabsTrigger>
          <TabsTrigger value="finance">Keuangan ({(d.length ?? 0) + (d.length ?? 0)})</TabsTrigger>
          <TabsTrigger value="qa">QA / K3 ({(d.length ?? 0) + (d.length ?? 0)})</TabsTrigger>
          <TabsTrigger value="issues">Permasalahan ({(d.length ?? 0)})</TabsTrigger>
        </TabsList>
