...
import sraLogo from "@/assets/sra-logo-mark.png.asset.json";
...
function AppHeader({ email, onSignOut, dark, setDark }: {
  email: string; onSignOut: () => void; dark: boolean; setDark: (v: boolean) => void;
}) {
  ...
  return (
    <SidebarProvider defaultOpen={defaultOpen}>
        ...
        <SidebarHeader className="gap-2 border-b border-sidebar-border/60 px-2 py-3">
          <div className="flex items-center gap-2.5 px-1.5">
            <div className="size-9 rounded-md bg-white/95 flex items-center justify-center p-1.5 shadow-sm shrink-0">
              <img src={sraLogo.url} alt="Sudut Ruang Arsitek" className="size-full object-contain" />
            </div>
      ...
      <SidebarInset className={cn("min-w-0 bg-background")}>
        <AppHeader email={email} onSignOut={signOut} dark={dark} setDark={setDark} />
